...
![qs tour](Documentation~/Images/quicksearch_tool_tour.gif)
...
![asset filter](Documentation~/Images/asset_provider_filters.png)
...
![asset filter](Documentation~/Images/settings_provider.png)
...
![answers](Documentation~/Images/answers_search.gif)

- [The Official Unity Documentation](docs.unity3d.com/Manual):

![manual](Documentation~/Images/manual_search.gif)

- [The Mighty Unity Asset Store](assetstore.unity.com):

![store](Documentation~/Images/store_search.gif)
...
![provider filter](Documentation~/Images/provider_filter.png)
...
![asset filter](Documentation~/Images/provider_specific_filter.png)

As usual you can pass the same search tokens used by the project browser to a search query:

![asset text filter](Documentation~/Images/asset_text_filter.png)

## Last Search

When opening the Quick Search Tool using ```Alt + ` ``` the state (and filters) of you previous search is preserved:

![last search](Documentation~/Images/last_search.gif)

## Recent Items

If the search box is empty, we display the 10 last searched items:

![recent items](Documentation~/Images/recent_items.png)

Note that those are affected by filters as well:

![recent items](Documentation~/Images/recent_items_filter.gif)

## Installation Setup

You can download or clone this project anywhere and locate it using the package manager:

![Open package manager](Documentation~/Images/open_package_manager.png)
![Add package from disk](Documentation~/Images/add_package_from_disk.png)
![Select package json file](Documentation~/Images/select_package_json.png)
![Show loaded package info](Documentation~/Images/package_loaded.png)
...
![recent items](Documentation~/Images/item_actions.png)
