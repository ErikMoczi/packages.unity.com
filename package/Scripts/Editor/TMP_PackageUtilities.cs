...
namespace TMPro
{
    public class TMP_ProjectConversionUtility : EditorWindow
    {
        ...
        private string m_ProjectScanResults = string.Empty;
        private Vector2 m_ProjectScanResultScrollPosition;
        ...
        void OnEnable()
        {
            ...
            m_ProjectScanResults = "<color=#FFFF00><b>Project Scan Results</b></color>\n";
        }
        ...
        void OnGUI()
        {
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.Label("To begin scanning your project for files & resources that were created with a previous version of TextMesh Pro, please click the button below.", TMP_UIStyleManager.Label);

                GUILayout.Space(5f);

                if (GUILayout.Button("Begin Scanning Project Files"))
                {
                ...
                // Scan project to identify files and resources to be converted to new TextMesh Pro UPM package format.


                // List project files and resources that have been identified for conversion.
            }
            GUILayout.EndVertical();
        }
        ...
        void SetEditorWindowSize()
        {
            ...
            editorWindow.minSize = new Vector2(Mathf.Max(640, currentWindowSize.x), Mathf.Max(300, currentWindowSize.y));
        }
        ...
        private static string ScanProjectFiles()
        {
            ...
            string scanResults = "<color=#FFFF00><b>Project Scan Results</b></color>\n";
