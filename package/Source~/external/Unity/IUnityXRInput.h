...
const uint32_t kUnityInvalidXRInputFeatureIndex = 0xffffffff;
...
enum UnityXRInputFeatureType
{
    ...
    kUnityXRInputFeatureTypeInvalid = 0xffffffff, ///< Represents an invalid feature type
};
...
enum UnityXRInputDeviceRole
{
    ...
    kUnityXRInputDeviceRoleInvalid = 0xffffffff ///< Represents an invalid device role
};
...
enum UnityXRInputFeatureUsage
{
    ...
    kUnityXRInputFeatureUsageInvalid = 0xffffffff ///< Represents an invalid feature usage
};
...
UNITY_REGISTER_INTERFACE_GUID(0x47B2126E444A168FULL, 0xFC25C91BFC672316ULL, IUnityXRInputInterface);
