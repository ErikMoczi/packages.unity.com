...
{
    public class LogAssertInSameScopeTests
    {
        ...
        private static ResultState ExpectedState = ResultState.Success;
        ...
        public class FromOneTimeSetup : SetUpTearDownTestBase
        {
            [OneTimeSetUp]
            public void Setup()
            {
        ...
        public class FromOneTimeTearDown : SetUpTearDownTestBase
        {
            [OneTimeTearDown]
            public void TearDown()
            {
