...
{
    internal partial struct TinyTweenDesc : ITinyStruct
    {
        private static TinyId s_Id = CoreIds.Tweens.TweenDesc;
        private static TinyType.Reference s_Ref = TypeRefs.Tweens.TweenDesc;
        ...
        public TinyTweenDesc(TinyObject tiny)
        {
            Tiny = tiny;
            UnityEngine.Assertions.Assert.IsNotNull(Tiny);
            UnityEngine.Assertions.Assert.AreEqual(tiny.Type.Id, StructId);
        }
        public TinyTweenDesc(IRegistry registry) : this(new TinyObject(registry, s_Ref))
        {
        }
        ...
        public void CopyFrom(TinyTweenDesc other)
        {
            @offset = other.@offset;
