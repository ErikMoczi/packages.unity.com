...
namespace UnityEditor.AddressableAssets
{
    ...
    internal class AddressableAssetInspectorGUI
    {
        ...
        static GUIContent addressableAssetToggleText = new GUIContent("Is Addressable", "Check this to mark this asset as an Addressable Asset, which includes it in the bundled data and makes it loadable via script by its address.");
