    ...
    public class OverrideTransformEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_SourceObjectsToggle.boolValue)
            {
                ...
                var overrideSrcTransform = m_OverrideSource.FindPropertyRelative("transform");
                using (new EditorGUI.DisabledScope(overrideSrcTransform.objectReferenceValue != null))
                {
