...
namespace UnityEditor.Build.WriteTypes
{
    ...
    public struct SceneBundleWriteOperation : IWriteOperation
    {
        ...
        {
            return BundleBuildInterface.WriteSceneSerializedFile(outputFolder, scene, processedScene, command, settings, globalUsage, usageSet, referenceMap, preloadInfo, info);
        }
    }
}
