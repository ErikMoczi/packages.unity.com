    ...
    internal class PackageValidationWindow
    {
        ...
        internal static void ShowPackageManagerWindow()
        {
            ...
            try
            {
                ...
                File.WriteAllText(ValidationSuite.resultsFilePath, string.Format("Validation Suite Results for package \"{0}\"\r\n\r\n", packagePath));
            ...
            {
                File.AppendAllText(ValidationSuite.resultsFilePath, string.Format("\r\nTest Setup Error: \"{0}\"\r\n", e.Message));
            }
        }
