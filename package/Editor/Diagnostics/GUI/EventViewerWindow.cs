...
namespace UnityEditor.ResourceManagement.Diagnostics
{
    public class EventViewerWindow : EditorWindow, IComparer<EventDataSet>
    {
        ...
        private void OnEnable()
        {
            ...
            EditorConnection.instance.Register(DiagnosticEventCollector.EventGuid, OnPlayerConnectionMessage);
        ...
        {
            EditorConnection.instance.Unregister(DiagnosticEventCollector.EventGuid, OnPlayerConnectionMessage);
