...
public static class LODGroupExtensions
{
    public struct LODParams : IEqualityComparer<LODParams>, IEquatable<LODParams>
    {
        ...
        public bool Equals(LODParams x, LODParams y)
        {
            return
                ...
                x.screenRelativeMetric == y.screenRelativeMetric &&
                x.isOrtho == y.isOrtho &&
        ...
        public bool Equals(LODParams x)
        {
            return
                ...
                x.screenRelativeMetric == screenRelativeMetric &&
                x.isOrtho == isOrtho &&
    ...
    public static LODParams CalculateLODParams(LODParameters parameters)
    {
        LODParams lodParams;
        ...
        var halfAngle = math.tan(math.radians(parameters.fieldOfView * 0.5F));
