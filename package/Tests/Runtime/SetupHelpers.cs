...
public class TestSetupHelpers : TestBaseSetup
{
    ...
    private OculusSettings m_XrSettings;
    private OculusLoader m_OculusLoader;

    public void CreateXRGameObjects()
    {
        m_XrSettings = new OculusSettings();
        m_XrManager = Instantiate(Resources.Load("TestSetup/XR Manager")) as GameObject;
        m_TrackingRig = Instantiate(Resources.Load("TestSetup/TrackingRig") as GameObject);
    }
    ...
    {
        Object.Destroy(GameObject.Find("Main Camera"));
...
#if UNITY_EDITOR
    public void EnsureMultiPassRendering()
    {
        m_XrSettings.StereoRenderingMode = OculusSettings.StereoRenderingModes.MultiPass;
    }

    public void EnsureInstancingRendering()
    {
        m_XrSettings.StereoRenderingMode = OculusSettings.StereoRenderingModes.SinglePassInstanced;    
    }
#endif
