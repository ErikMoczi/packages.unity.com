...
namespace UnityEditor.Experimental.U2D.Animation.Test.MeshModule.SpriteMesh
{
    ...
    public class SpriteMeshViewTest : BaseViewTest
    {
        ...
        public class CommandTestCase : ActionTestCase
        {
            ...
            public override string ToString()
            {
                ...
                if (commandEventType == CommandEventType.Validate)
                    nameOverride = name + (expected ? "_Validates" : "_IgnoresValidation");

                return nameOverride;
            }
        }

        private const int kCreateVertexControlID = 1001;
        private const int kCreateEdgeControlID = 1002;
        private const int kSplitEdgeControlID = 1003;
        ...
        protected override int GetControlID(int hashCode, FocusType focusType)
        {
            if (hashCode == "CreateVertex".GetHashCode())
                return kCreateVertexControlID;
            if (hashCode == "CreateEdge".GetHashCode())
                return kCreateEdgeControlID;
            if (hashCode == "SplitEdge".GetHashCode())
                return kSplitEdgeControlID;

            return base.GetControlID(hashCode, focusType);
        }
        ...
        private void SetupBaseTestCase(BaseTestCase testCase)
        {
            ...
            if (testCase.selectedVertex >= 0)
            {
                ...
                m_Selection.single.Returns(testCase.selectedVertex);
                m_Selection.IsSelected(testCase.selectedVertex).Returns(true);
            }
        }
        ...
        {
            yield return new ActionTestCase() { name = "SelectionMode_DoubleClick", expected = true, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { clickCount = 2, mouseDownButton = 0 }};
            yield return new ActionTestCase() { name = "SelectionMode_DoubleClick_AltIsDown", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { clickCount = 2, mouseDownButton = 0, isAltDown = true} };
            yield return new ActionTestCase() { name = "SelectionMode_DoubleClick_HotControlSet", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { clickCount = 2, mouseDownButton = 0, hotControl = 30 } };
            yield return new ActionTestCase() { name = "SelectionMode_DoubleClick_VertexIsHovered", expected = false, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, state = new GUIWrapperState() { clickCount = 2, mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_DoubleClick_EdgeIsHovered", expected = false, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, state = new GUIWrapperState() { clickCount = 2, mouseDownButton = 0 } };
        ...
        {
            yield return new BaseTestCase() { name = "CreateVertexMode_MouseMove_UsesEvent", expected = true, mode = SpriteMeshViewMode.CreateVertex, eventType = EventType.MouseMove, forceNearestControl = kCreateVertexControlID, state = new GUIWrapperState() };
            yield return new BaseTestCase() { name = "CreateVertexMode_MouseDrag_UsesEvent", expected = true, mode = SpriteMeshViewMode.CreateVertex, eventType = EventType.MouseDrag, forceNearestControl = kCreateVertexControlID, state = new GUIWrapperState() { mouseButton = 0 } };
        }
        ...
        {
            yield return new SelectTestCase() { name = "SelectionMode_HoveredVertex_Click", expected = true, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new SelectTestCase() { name = "SelectionMode_NoHoveredVertex_Click", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new SelectTestCase() { name = "SelectionMode_SelectedVertex_SameHoveredVertex_Click", expected = true, mode = SpriteMeshViewMode.Selection, selectedVertex = 100, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new SelectTestCase() { name = "SelectionMode_SelectedVertex_SameHoveredVertex_Click_ActionKeyIsDown", expected = true, expectedAdditive = true, mode = SpriteMeshViewMode.Selection, selectedVertex = 100, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isActionKeyDown = true } };
            yield return new SelectTestCase() { name = "SelectionMode_HoveredVertex_Click_ActionKeyIsDown", expected = true, expectedAdditive = true, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isActionKeyDown = true } };
            yield return new SelectTestCase() { name = "SelectionMode_HoveredVertex_Click_AltIsDown", expected = false, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isAltDown = true } };
            yield return new SelectTestCase() { name = "SelectionMode_HoveredVertex_Click_HotControlSet", expected = false, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, hotControl = 30 } };
        ...
        {
            yield return new ActionTestCase() { name = "SelectionMode_HoveredVertex_Click", expected = true, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_NoVertexHovered_Click", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredVertex_Click_CreateVertexActionActive", expected = false, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, forceNearestControl = kCreateVertexControlID, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredVertex_Click_CreateEdgeActionActive", expected = false, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, forceNearestControl = kCreateEdgeControlID, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredVertex_Click_SplitEdgeActionActive", expected = false, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, forceNearestControl = kSplitEdgeControlID, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredVertex_Click_AltIsDown", expected = false, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isAltDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredVertex_Click_HotControlSet", expected = false, mode = SpriteMeshViewMode.Selection, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, hotControl = 30 } };
        ...
        {
            yield return new ActionTestCase() { name = "SelectionMode_SelectedVertex_Shift_Click", expected = true, mode = SpriteMeshViewMode.Selection, selectedVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_NoSelection_Shift_Click", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_SelectedVertex_Shift_Click_AltIsDown", expected = false, mode = SpriteMeshViewMode.Selection, selectedVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true, isAltDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_SelectedVertex_Shift_Click_HotControlSet", expected = false, mode = SpriteMeshViewMode.Selection, selectedVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true, hotControl = 30 } };
            yield return new ActionTestCase() { name = "SelectionMode_SelectedVertex_DifferentHoveredVertex_Shift_Click", expected = true, mode = SpriteMeshViewMode.Selection, selectedVertex = 100, hoveredVertex = 0, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_SelectedVertex_SameHoveredVertex_Shift_Click", expected = false, mode = SpriteMeshViewMode.Selection, selectedVertex = 100, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_SelectedVertex_HoveredEdge_Shift_Click", expected = true, mode = SpriteMeshViewMode.Selection, selectedVertex = 100, hoveredEdge = 0, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
        ...
        {
            yield return new BaseTestCase() { name = "CreateEdgeMode_MouseMove_UsesEvent", expected = true, mode = SpriteMeshViewMode.CreateEdge, eventType = EventType.MouseMove, forceNearestControl = kCreateEdgeControlID, state = new GUIWrapperState() };
            yield return new BaseTestCase() { name = "CreateEdgeMode_MouseDrag_UsesEvent", expected = true, mode = SpriteMeshViewMode.CreateEdge, eventType = EventType.MouseDrag, forceNearestControl = kCreateEdgeControlID, state = new GUIWrapperState() { mouseButton = 0 } };
        }
        ...
        {
            yield return new SelectTestCase() { name = "SelectionMode_HoveredEdge_Click", expected = true, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new SelectTestCase() { name = "SelectionMode_NoHoveredEdge_Click", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new SelectTestCase() { name = "SelectionMode_HoveredEdge_Click_ActionKeyIsDown", expected = true, expectedAdditive = true, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0, isActionKeyDown = true } };
            yield return new SelectTestCase() { name = "SelectionMode_HoveredEdge_Click_AltIsDown", expected = false, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0, isAltDown = true } };
            yield return new SelectTestCase() { name = "SelectionMode_HoveredEdge_Click_HotControlSet", expected = false, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0, hotControl = 30 } };
            yield return new SelectTestCase() { name = "SelectionMode_HoveredEdge_Click_CreateEdgeActionActive", expected = false, mode = SpriteMeshViewMode.Selection, forceNearestControl = kCreateEdgeControlID, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new SelectTestCase() { name = "SelectionMode_HoveredEdge_Click_SplitEdgeActionActive", expected = false, mode = SpriteMeshViewMode.Selection, forceNearestControl = kSplitEdgeControlID, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0 } };
        ...
        {
            yield return new ActionTestCase() { name = "SelectionMode_HasClosestNonHoveredEdge_ShiftDown_Click", expected = true, mode = SpriteMeshViewMode.Selection, nonHoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredEdge_ShiftDown_Click", expected = true, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_HasNoClosestEdge_ShiftDown_Click", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_HasClosestNonHoveredEdge_HoveredVertex_ShiftDown_Click", expected = false, mode = SpriteMeshViewMode.Selection, nonHoveredEdge = 100, hoveredVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_HasClosestNonHoveredEdge_SelectedVertex_ShiftDown_Click", expected = false, mode = SpriteMeshViewMode.Selection, nonHoveredEdge = 100, selectedVertex = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_HasClosestNonHoveredEdge_ShiftDown_Click_AltIsDown", expected = false, mode = SpriteMeshViewMode.Selection, nonHoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true, isAltDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_HasClosestNonHoveredEdge_ShiftDown_Click_HotControlSet", expected = false, mode = SpriteMeshViewMode.Selection, nonHoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0, isShiftDown = true, hotControl = 30 } };
        ...
        {
            yield return new BaseTestCase() { name = "SplitEdgeMode_MouseMove_UsesEvent", expected = true, mode = SpriteMeshViewMode.SplitEdge, eventType = EventType.MouseMove, forceNearestControl = kSplitEdgeControlID, state = new GUIWrapperState() };
            yield return new BaseTestCase() { name = "SplitEdgeMode_MouseDrag_UsesEvent", expected = true, mode = SpriteMeshViewMode.SplitEdge, eventType = EventType.MouseDrag, forceNearestControl = kSplitEdgeControlID, state = new GUIWrapperState() { mouseButton = 0 } };
        }
        ...
        {
            yield return new ActionTestCase() { name = "SelectionMode_HoveredEdge_Click", expected = true, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_NoEdgeHovered_Click", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredEdge_Click_CreateVertexActionActive", expected = false, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, forceNearestControl = kCreateVertexControlID, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredEdge_Click_CreateEdgeActionActive", expected = false, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, forceNearestControl = kCreateEdgeControlID, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredEdge_Click_SplitEdgeActionActive", expected = false, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, forceNearestControl = kSplitEdgeControlID, state = new GUIWrapperState() { mouseDownButton = 0 } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredEdge_Click_AltIsDown", expected = false, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0, isAltDown = true } };
            yield return new ActionTestCase() { name = "SelectionMode_HoveredEdge_Click_HotControlSet", expected = false, mode = SpriteMeshViewMode.Selection, hoveredEdge = 100, state = new GUIWrapperState() { mouseDownButton = 0, hotControl = 30 } };
        ...
        {
            yield return new CommandTestCase() { name = "SelectionMode_ValidateDeleteCommand", expected = true, mode = SpriteMeshViewMode.Selection, commandEventType = CommandEventType.Validate, commandName = kDeleteCommandName, state = new GUIWrapperState() };
            yield return new CommandTestCase() { name = "SelectionMode_ExecuteDeleteCommand", expected = true, mode = SpriteMeshViewMode.Selection, commandEventType = CommandEventType.Execute, commandName = kDeleteCommandName, state = new GUIWrapperState() };
            yield return new CommandTestCase() { name = "SelectionMode_OtherEvent", expected = false, mode = SpriteMeshViewMode.Selection, commandEventType = CommandEventType.Other, state = new GUIWrapperState() };
            yield return new CommandTestCase() { name = "SelectionMode_ValidateDeleteCommand_AltIsDown", expected = false, mode = SpriteMeshViewMode.Selection, commandEventType = CommandEventType.Validate, commandName = kDeleteCommandName, state = new GUIWrapperState() { isAltDown = true } };
            yield return new CommandTestCase() { name = "SelectionMode_ExecuteDeleteCommand_AltIsDown", expected = false, mode = SpriteMeshViewMode.Selection, commandEventType = CommandEventType.Execute, commandName = kDeleteCommandName, state = new GUIWrapperState() { isAltDown = true } };
            yield return new CommandTestCase() { name = "SelectionMode_ValidateDeleteCommand_HotControlSet", expected = false, mode = SpriteMeshViewMode.Selection, commandEventType = CommandEventType.Validate, commandName = kDeleteCommandName, state = new GUIWrapperState() { hotControl = 30 } };
            yield return new CommandTestCase() { name = "SelectionMode_ExecuteDeleteCommand_HotControlSet", expected = false, mode = SpriteMeshViewMode.Selection, commandEventType = CommandEventType.Execute, commandName = kDeleteCommandName, state = new GUIWrapperState() { hotControl = 30 } };
        ...
        private static IEnumerable<ActionTestCase> CancelModeCases()
        {
            ...
            yield return new ActionTestCase() { name = "SelectionMode_RightClick", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { mouseDownButton = 1 } };
            yield return new ActionTestCase() { name = "SelectionMode_EscapeKey", expected = false, mode = SpriteMeshViewMode.Selection, state = new GUIWrapperState() { keyDown = KeyCode.Escape } };
        }
        ...
        public void CancelMode([ValueSource("CancelModeCases")] ActionTestCase testCase)
        {
            ...
            if (testCase.expected)
            {
                Assert.AreEqual(SpriteMeshViewMode.Selection, m_SpriteMeshView.mode, "Mode did not change to Selection");
                guiWrapper.Received(1).UseCurrentEvent();
            }
            else
            {
