...
These details include the following information:
 ...
 - \(C\) The links to open the package documentation page and the package change log
 ...
 - (J) Button to remove the package
...
To access it, click the View Documentation link in the [details pane](#PackManDetails):
