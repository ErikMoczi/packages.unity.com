...
namespace UnityEngine.XR.ARFoundation
{
    ...
    /// </summary>
    /// <remarks>
    /// This component only responds to changes in detected planes while it is enabled. For example, if it is not enabled,
    /// planes may be generated by the device without this component knowing about them. When it is later
    /// enabled, it will not create <see cref="ARPlane"/>s for those unless it later receives an event for it, such as updated.
    /// </remarks>
