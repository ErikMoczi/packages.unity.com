...
namespace UnityEngine.XR.ARFoundation
{
    ...
    /// </summary>
    public struct ARPlaneChangedEventArgs : IEquatable<ARPlaneChangedEventArgs>
    {
        /// <summary>
        ...
        public ARPlaneChangedEventArgs(
            List<ARPlane> added,
        ...
        {
            if (!(obj is ARPlaneChangedEventArgs))
                return false;

            return Equals((ARPlaneChangedEventArgs)obj);
        }
        ...
        public bool Equals(ARPlaneChangedEventArgs other)
        {
            return
                (added == other.added) &&
        ...
        public static bool operator ==(ARPlaneChangedEventArgs lhs, ARPlaneChangedEventArgs rhs)
        {
